...
const MEASURE_ALIASES: string[][] = [
  ["revenue", "receita", "sales", "vendas", "amount", "valor", "valor_mensal", "faturamento", "gmv", "vgv", "billing", "turnover", "net_sales", "total", "valor_venda"],
  ...
  ["comissao", "commission", "honorario", "honorarios"],
  ["area_m2", "area", "metragem", "m2"],
  ["valor_aluguel", "aluguel", "renda", "rent"],
  ["inadimplencia", "atraso", "default"],
  ["leads", "lead", "oportunidades"],
  ["ocupacao", "occupancy", "taxa_ocupacao"],
  ["vacancia", "vacancy", "vazio"],
  ["dias_estoque", "aging", "dias_anuncio"],
  ...
  ["nota", "score", "rating", "desempenho", "avaliacao", "performance"],
  ["atingimento", "atingimento_pct", "meta_pct"],
...
const DIMENSION_ALIASES: string[][] = [
  ...
  ["region", "regiao", "uf", "estado", "cidade", "city", "country", "pais", "territorio", "bairro", "zona"],
  ["product", "produto", "sku", "item", "item_name", "imovel", "unidade", "codigo_imovel"],
  ["category", "categoria", "linha", "rubrica", "classificacao", "segmento", "segment", "tipologia", "tipo_imovel"],
  ["customer", "cliente", "account", "conta", "inquilino", "proprietario", "comprador"],
  ["sales_rep", "vendedor", "seller", "representante", "owner", "agente", "corretor", "captador"],
  ["channel", "canal", "origem", "source", "utm", "portal"],
  ["status", "situacao", "etapa", "stage", "pipeline"],
  ["natureza", "tipo", "type", "kind", "finalidade"],
  ["company", "empresa", "filial", "loja", "store", "unidade", "branch", "empreendimento", "condominio", "edificio"],
  ["department", "departamento", "area", "cargo", "role", "funcao", "team", "time"],
  ["employee", "colaborador", "funcionario", "pessoa"],
