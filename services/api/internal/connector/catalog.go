...
func Catalog() []Item {
	items := []Item{
		...
		},
		{
			...
			Description: "ERP TOTVS via REST (clientes, pedidos, produtos).", Implemented: true, Preview: false,
			Aliases: []string{"protheus", "totvs"},
			Fields: append(nameField(), []Field{
				{Key: "url", Label: "URL da API REST", Type: "url", Required: true, Placeholder: "https://servidor:porta/rest"},
				{Key: "token", Label: "Token / Bearer", Type: "password", Hint: "Token de autenticação do Protheus REST."},
		...
		},
		{
			...
			Description: "Service Layer (BusinessPartners, Orders, Items).", Implemented: true, Preview: false,
		...
		},
		{
			...
			Description: "ERP / RH Senior via REST.", Implemented: true, Preview: false,
